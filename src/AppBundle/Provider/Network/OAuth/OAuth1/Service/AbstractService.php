...
use AppBundle\Provider\Network\OAuth\OAuth1\Token\TokenInterface;
use AppBundle\Provider\Network\OAuth\OAuth1\Token\StdOAuth1Token;
use AppBundle\Provider\Network\OAuth\Common\Service\AbstractService as BaseAbstractService;
...
abstract class AbstractService extends BaseAbstractService implements ServiceInterface
{
    ...
    public function redirect()
    {
        ...
        $url = $this->getAuthorizationUri(['oauth_token' => $token->getRequestToken()]);
